...
public class CarTest {
    public static void main(String[] args) {
       ...
       System.out.println(c2.get().getModel());
        ...
        BiFunction<String,String,Car> b1=(make,model)-> new Car(make,model);
        Car honda= b1.apply("Honda","2001");
        System.out.println(honda.getMake() + " " + honda.getModel());


        BiFunction<String,String,Car> b2=Car::new;
        Car nissan= b2.apply("Nissan","2066");
